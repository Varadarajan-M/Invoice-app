    ...
    >
      <Form
        ...
        onSubmit={handleSubmit(
          (d) => console.log('data', formatInvoiceData(d)),
      ...
      >
        ...
        <main className='invoice-form-children' style={{ ...theme.body }}>
          <FormContent control={control} register={register} errors={errors} />
        </main>

        <footer className='invoice-form-buttons' style={{ ...theme.body }}>
          {
            <Button
              type='button'
